...
import css from './LocationSelectForm.css';

const identity = v => v;

class LocationSelectFormComponent extends Component {
  constructor(props) {
    super(props);
...
const LocationSelectForm = injectIntl(LocationSelectFormComponent);
