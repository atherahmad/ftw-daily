...
export const NamedLinkBlankComponent = props => {
  ...
  return (
    <Link to={{ pathname, ...to }} {...aElemProps} target="_blank">
      {children}
    </Link>
  );
};
...
NamedLinkBlankComponent.defaultProps = {
  params: {},
  to: {},
  children: null,
  className: '',
...
NamedLinkBlankComponent.displayName = 'NamedLinkBlank';

NamedLinkBlankComponent.propTypes = {
...
const NamedLinkBlank = withRouter(NamedLinkBlankComponent);
NamedLinkBlank.displayName = 'NamedLinkBlank';

export default NamedLinkBlank;
