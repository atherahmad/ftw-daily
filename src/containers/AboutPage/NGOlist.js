    ...
    <div className={classes.root}>
      ...
      >
        <AccordionSummary
          ...
          id="panel1bh-header"
        >
          <Typography className={classes.heading}>Afrika (18)</Typography>
        </AccordionSummary>
      ...
      >
        <AccordionSummary
          ...
          id="panel2bh-header"
        >
          <Typography className={classes.heading}>Amerika (7)</Typography>
        </AccordionSummary>
        <AccordionDetails>
          <Typography>
      ...
      >
        <AccordionSummary
          ...
          id="panel3bh-header"
        >
          <Typography className={classes.heading}>Asien (24)</Typography>
        </AccordionSummary>
        <AccordionDetails>
          <Typography>
      ...
      >
        <AccordionSummary
          ...
          id="panel4bh-header"
        >
          <Typography className={classes.heading}>Europa (12)</Typography>
        </AccordionSummary>
        <AccordionDetails>
          <Typography>
            Nunc vitae orci ultricies, auctor nunc in, volutpat nisl. Integer sit amet egestas eros,
